...
public class CarController {
	...
	{
		Optional <Car> optCar = Optional.of(carService.getById(id));
		...
		{
			return new ResponseEntity<>(optCar.get(), HttpStatus.NOT_FOUND);
		}
	}
	...
	{
		List<Car> cars = carService.getByColor(brand);
	...
	public ResponseEntity<Car> updateCar(@PathVariable("id") long id, @RequestBody Car car)
	{
	    ...
	    if (existingCar != null)
	    {
	      ...
	      updatedCar.setCylinder(car.getCylinder());
